...
func TestArticleRepositoryImpl_Create(t *testing.T) {
	...
	t.Run("successful article creation", func(t *testing.T) {
		...
		mock.ExpectBegin()
		mock.ExpectQuery(regexp.QuoteMeta(`INSERT INTO "articles" ("title","content","author_id","status","created_at","updated_at") VALUES ($1,$2,$3,$4,$5,$6) RETURNING "id"`)).
			WithArgs("Test Article", "Test Content", 1, "draft", sqlmock.AnyArg(), sqlmock.AnyArg()).
...
func TestArticleRepositoryImpl_Update(t *testing.T) {
	...
	t.Run("successful article update", func(t *testing.T) {
		...
		mock.ExpectBegin()
		mock.ExpectExec(regexp.QuoteMeta(`UPDATE "articles" SET "title"=$1,"content"=$2,"author_id"=$3,"status"=$4,"created_at"=$5,"updated_at"=$6 WHERE "id" = $7`)).
			WithArgs("Updated Title", "Updated Content", 1, "published", sqlmock.AnyArg(), sqlmock.AnyArg(), 1).
